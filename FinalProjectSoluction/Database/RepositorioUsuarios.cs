...
namespace Database
{
    public class RepositorioUsuarios
    {
        ...
        public bool Add(Usuarios item)
        {
            ...
            SqlCommand command = new SqlCommand("inser into Usuarios(Nombre, Apellido, Correo, Contraseña, TipoDeUsuario) value(@nombre, @apellido, @correo, @contraseña, @tipoDeUsuario)", connection);
        ...
        public bool Update(Usuarios item)
        {
            ...
            SqlCommand command = new SqlCommand("update Nombre = @nombre, Apellido = @apellido, Correo = @correo, Contraseña = @contraseña, TipoDeUsuario = @tipoDeUsuario from Usuarios where Id = @id", connection);
        ...
        public DataTable GetAll()
        {
            try
            {
                ...
                SqlDataAdapter query = new SqlDataAdapter("select Id as ID, Nombre, Apellido, Correo, Contraseña, TipoDeUsuario from Usuarios ", connection);
